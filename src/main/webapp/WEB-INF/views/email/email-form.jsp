    ...
    <script>
        ...
        document.getElementById('mail-check-btn').onclick = () => {
            ...
            .then(data => {
                ...
                // 이메일 전송이 완료되면 이메일 입력창을 readOnly로 막기 (자유롭게 진행)
        ...
        document.getElementById('mail-check-input').onblur = e => {
            ...
            if (inputCode === code) {
                ...
                document.getElementById('mail-check-btn').disabled = true; // 버튼 비활성화
            } else {
                document.getElementById('mailCheckMsg').textContent = '인증번호를 다시 확인해주세요';
