...
public class WeatherService {
    ...
    public void getShortTermForecast(String area1, String area2) {
        ...
        try {
            StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getVilageFcst"); /*URL 단기예보는 변경*/
            urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=idBX3%2B6we1fl%2B5Lcfjj5uJkGR0fs0SzuBEprwp607JLr0nA%2BQZsSngkKv9JOg9QtUk6%2BN8%2BsrKmqjUXvi1J0wg%3D%3D"); /*Service Key*/
            ...
            if(conn.getResponseCode() >= 200 && conn.getResponseCode() <= 300) { // 응답이 200번대 -> 요청이 성공적
