...
public class ScoreController {
    ...
    public String register(ScoreRequestDTO dto) {
        ...
        /*
            ...
            - redirect 할 때는 다시 들어왔으면 하는 요청 url 작성 (/score/list -> 목록 요청)
         */
...
//        model.addAttribute("s", service.findOne(stuNum)); // Score 타입
    ...
    public String modify(ScoreRequestDTO dto, int stuNum) {
        ...
        // 서비스, 레파지토리 계층과 연계하여 update 처리를 진행
        service.modifyScore(stuNum, dto);
