...
@Controller // 빈 등록 어노테이션, 이 클래스의 객체 생성 및 관리는 스프링 컨테이너가 처리
...
//    @RequestMapping(value = "/food", method = RequestMethod.GET)
    ...
    public String food() {
        ...
        // 경로를 작성할 때는 view resolver 세팅(application.properties 파일)에 작성된 접두어, 접미어를 고려하여 씁니다.
        // /WEB-INF/views/~~~~~.jsp
        return "chap01/food";
    }
...
//    @RequestMapping(value = "/food", method = RequestMethod.POST)
    ...
    // 2. @RequestParam 사용하기
    // 파라미터 변수명과 매개변수명을 동일하게 맞추면 @RequestParam 을 생략할 수 있다.
    /*@PostMapping("/food")
