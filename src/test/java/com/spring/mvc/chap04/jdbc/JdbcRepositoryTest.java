...
class JdbcRepositoryTest {
    ...
    @Test
    @DisplayName("회원번호가 1번인 회원을 삭제해야 한다.")
    void deleteTest() {
    ...
    @Test
    @DisplayName("전체 회원을 조회하면 회원 리스트의 사이즈는 12일 것이다.")
    void findAllTest() {
    ...
    @Test
    @DisplayName("특정 아이디 회원을 조회하면 하나의 회원만 조회될 것이고, 없는 id를 전달하면 null이 리턴될 것이다.")
    void findOneTest() {
        int id = 6;
